...
//    public HttpSecurity configureOpenMatchers(HttpSecurity http) throws Exception{
//        String role;
//
//        for (String s : properties.getMatchers().keySet()) {
//            role = s;
//            String[] pages = properties.getMatchers().get(role);
//
//            for (String page : pages) {
//                http.authorizeHttpRequests().
